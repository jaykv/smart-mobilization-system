...
<html lang="en">
  <head>
    ...
    <title>Smart mobilization system - Rescue</title>
  ...
  <body class="mdl-demo mdl-color--grey-100 mdl-color-text--grey-700 mdl-base">
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
      <header class="mdl-layout__header mdl-layout__header--scroll mdl-color--primary">
        ...
        <div class="mdl-layout--large-screen-only mdl-layout__header-row">
          <i class="material-icons">add_alert</i><h3>  Disaster Rescue and Prediction</h3>
        </div>
        <div class="mdl-layout--large-screen-only mdl-layout__header-row">
        </div>
        <div class="mdl-layout__tab-bar mdl-js-ripple-effect mdl-color--primary-dark">
          <a href="#overview" class="mdl-layout__tab is-active">Activity</a>
          <a href="#features" class="mdl-layout__tab">Threat Analysis</a>
      ...
      <main class="mdl-layout__content">
        <div class="mdl-layout__tab-panel is-active" id="overview">
          ...
          <section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp">
            <div class="mdl-card mdl-cell mdl-cell--12-col">
              <div class="mdl-card__supporting-text mdl-grid mdl-grid--no-spacing">
                <h4 class="mdl-cell mdl-cell--12-col">Active Threats</h4>
				
                <div class="section__circle-container mdl-cell mdl-cell--2-col mdl-cell--1-col-phone">
                  <div class="section__circle-container__circle mdl-color--primary"></div>
                </div>
                <div class="section__text mdl-cell mdl-cell--10-col-desktop mdl-cell--6-col-tablet mdl-cell--3-col-phone">
                  <h5>Raging wildfire in Santa Paula, California</h5>
                  Rescue operation needed in <a href="https://goo.gl/maps/YLK5wFwxzKENNBwN6">Santa Paula Theatres</a>
                  <div class="mdl-card__actions">
                    <a href="#" class="mdl-button">Send Alert</a>
                  </div>
                </div>
                <div class="section__circle-container mdl-cell mdl-cell--2-col mdl-cell--1-col-phone">
                  <div class="section__circle-container__circle mdl-color--primary"></div>
                ...
                <div class="section__text mdl-cell mdl-cell--10-col-desktop mdl-cell--6-col-tablet mdl-cell--3-col-phone">
                  <h5>Flood Warning for Randolph and Jackson Counties, Illinois</h5>
                  Rainfall heavier than forecast could cause river levels to rise even
                  higher than predicted. <a href="https://goo.gl/maps/w5tfYyGs8DnrLcjC9">Location Link</a>
                  <div class="mdl-card__actions">
                    <a href="#" class="mdl-button">Send Alert</a>
                  </div>
                </div>
          ...
          <section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp">
            <div class="mdl-card mdl-cell mdl-cell--12-col">
              <div class="mdl-card__supporting-text">
                <h4>Technology</h4>
                Active threat notifications are listed according to the severity of threat detected
                 based on rescue calls received. Notifications about potential disaster threat is sent to residents in locality.
              </div>
              <!-- <div class="mdl-card__actions">
                <a href="#" class="mdl-button">Read our features</a>
              </div> -->
        ...
        <div class="mdl-layout__tab-panel" id="features">
          <section class="section--center mdl-grid mdl-grid--no-spacing">
            ...
            <div class="mdl-card mdl-cell mdl-cell--9-col-desktop mdl-cell--6-col-tablet mdl-cell--4-col-phone">
              <div class="mdl-card__supporting-text">
                <h4>Threat Prediction Analysis</h4>
                <div class="mdc-text-field mdc-text-field--outlined">
                  <input type="text" id="tf-outlined" class="mdc-text-field__input">
                  <div class="mdc-notched-outline">
                    <div class="mdc-notched-outline__leading"></div>
                    <div class="mdc-notched-outline__notch">
                      <label for="tf-outlined" class="mdc-floating-label">Enter location</label>
                  </div>
                    <div class="mdl-card__actions">
                      <a href="#" class="mdl-button">Search and predict</a>
                  </div>
                    <div class="mdc-notched-outline__trailing"></div>
                  </div>
                </div>
                Predicts threat in nearby location based on activity. Rescue team can then send alerts to residents based on location.
              </div>
            </div>  
<!-- 
